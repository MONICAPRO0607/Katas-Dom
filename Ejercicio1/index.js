...
var elementosTestMe = document.querySelectorAll('[data-function="testMe"]');
var contador = 0;

for (var i = 0; i < elementosTestMe.length; i++) {
  if (elementosTestMe[i]) {
    contador++;
    if (contador === 3) {
      console.log(elementosTestMe[i]);
      break;
    }
  }
}